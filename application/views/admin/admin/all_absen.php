...
<div class="col-md-12">
 ...
 <div class="box-body">              
<form target="_blank" role="form" method="POST" enctype="multipart/form-data" action="<?php echo base_url().'Download_app/laporan_xls';?>">
 ...
 <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                    <span class="input-group-btn">
                      <button type="submit" name="download_report" class="btn btn-success btn-flat">Download Report</button>
                    </span>
              </div> 
    </form>  
...
<div class="box box-primary">
            <div class="box-body"> 
            <form role="form" method="POST" enctype="multipart/form-data" action="<?php echo base_url().'Manage_app/all_absen';?>">
               <div class="input-group input-group-sm">
                <input type="text" class="form-control" id="tanggalcari" name="rangetanggal" placeholder="Filter Tanggal">
 <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                    <span class="input-group-btn">
...
<div class="col-lg-12">
 <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Semua Daftar Absensi</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
 <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables1">
            ...
            ?>                    
                <tr>
                  ...
                  <td><span class="badge bg-purple"><?php echo $log[$i]['NAMA'];?></span></td>
...
<p><?php echo $data_masuk[0]['IP'].' - '.$data_masuk[0]['LOKASI'];?> <a href="<?php echo "https://www.google.com/maps/place/".$data_masuk[$i]['GPS'];?>" target="_BLANK" class="badge bg-red"><i class="fa fa-map-o"></i></a></p>
<p><img width="200" src="<?php echo base_url().'assets/upload/'.$data_masuk[0]['GAMBAR'];?>"/></p>
<p><?php echo $data_keluar[0]['IP'].' - '.$data_keluar[0]['LOKASI'];?> <a href="<?php echo "https://www.google.com/maps/place/".$data_keluar[$i]['GPS'];?>" target="_BLANK" class="badge bg-red"><i class="fa fa-map-o"></i></a></p>
