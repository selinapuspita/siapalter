...
<p></p>
    ...
    <div id="webcam">
        <hr>
        <input type=button value="AMBIL FOTO" class="btn btn-block bg-blue" onClick="preview()">
    </div>
    <div id="simpan" style="display:none">
        <hr>
        <input type=button value="SIMPAN" class="btn btn-block bg-green" onClick="simpan()" style="font-weight:bold;">        
        <input type=button value="ULANGI" class="btn btn-block btn-warning" onClick="batal()">
        ...
        function simpan() {
            ...
            Webcam.snap(function(data_uri) {
                ...
                document.getElementById('hasil').innerHTML = 
                    '<img src="'+data_uri+'"/>' +
                    '<br><br>' +
                    '<form role="form" action="<?php echo base_url('Manage_app/submit_pengecekan'); ?>" method="post" name="login">'+
                    ...
                    '<input name="pos" type="hidden" value="<?php echo $pos;?>" >'+                    
                    ...
                    '<textarea cols="40" rows="3" name="ket" required type="text" placeholder="Isi Informasi Sekitar Lokasi" value=""></textarea><br>'+                    
                    '<input name="submitcek" type="submit" class="btn btn-primary btn-block bg-green" value="KIRIM" >'+    
                    '</form>';
