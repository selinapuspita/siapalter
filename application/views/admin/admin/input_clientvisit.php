        ...
        function simpan() {
            ...
            Webcam.snap(function(data_uri) {
                ...
                document.getElementById('hasil').innerHTML = 
                    '<img src="'+data_uri+'"/>' +
                    '<br><br>' +
                    '<form role="form" action="<?php echo base_url('Manage_app/submit_clientvisit'); ?>" method="post" name="login">'+
                    ...
                    '<textarea cols="35" name="ket" type="text" placeholder="Keterangan Client Visit" value=""></textarea><br>'+                    
                    '<input name="submitclientvisit" type="submit" class="btn bg-green" value="KIRIM" >'+    
                    '</form>';
