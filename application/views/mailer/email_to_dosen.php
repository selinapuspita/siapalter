...
<body>
<h3>Notifikasi Submit Laporan Mahasiswa <?php echo $mahasiswa;?></h3>
<br>
<table border=2>
...
<i>*Silahkan Cek Laporan Tersebut di website kemudian berikan feedback dan penilaian <a href="<?php echo base_url();?>">disini</a></i>
